...
### Results:
 ![Visualization of Top Skills](Images\skills_demanded_all-data_roles.png)
...
### Results:
 ...
 ![Trending Top Skills for Data Analyst in India](Images\dataanalyst_trending_over_time.png)
...
```
### Results:
![Salary Analysis for the Data Analyst Roles in India](Images\salary_analysis.png)
...
```
### Results:
![In demand and Highest Paying skills for Data analysts in India](Images\Indemand.png)
...
### Results:
![Most_optimal_skills_to_learn](Images\optimal_skills.png)
